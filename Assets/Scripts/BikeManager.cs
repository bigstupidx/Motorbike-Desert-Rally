...
public class BikeManager : MonoBehaviour {
	...
	void Awake()
	{
		...
		if(GameObject.Find("Motorbike Extra") != null)
		{
			...
			extrabike.GetComponent<Rigidbody>().velocity = Vector3.zero;
...
//			removeExtraSpeed();
	...
	void setBikeProperties ()
	{
		...
		targetBike.GetComponent<Rigidbody>().isKinematic = false;
	...
	public void OnReset()
	{
		...
		bikesContols [data.currentBike].GetComponent<Rigidbody>().velocity = Vector3.zero;
	}
